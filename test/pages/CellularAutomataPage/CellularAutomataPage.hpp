...
namespace test {
    class CellularAutomataPage : public dao::ifc::IGeneralPage {
        ...
        dao::RectTextBox randomFillTextBox{
            25, 300, 72 * 2, 36, 36, dao::ColorRGBA("#FFFFFF"), dao::ColorRGBA("#181A1D"), U"随机填充"
        };
        //TestStaticDraw test{getBatchRenderer()};
    public:
        CellularAutomataPage(dao::BatchRenderer *vertexBatch, dao::Context *context)
            : IGeneralPage(vertexBatch, context, "CellularAutomataPage") {
