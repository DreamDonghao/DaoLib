...
namespace dao {
    /// @brief 圆形图形组件
    /// @details 以圆心为共同顶点、边缘点为底的三角形扇形（triangle fan）方式渲染，分段数决定圆的平滑度
    ...
    public:
        ...
        Circle(f32 cx, f32 cy, f32 radius, const ColorRGBA &color = White, i32 segments = 32);
        ...
        /// @brief 设置分段数
        /// @param segments 分段数，越大越平滑（需要重新生成顶点）
    ...
    private:
        ...
        std::vector<Vertex> m_vertices; ///< 顶点数组：[0]=圆心，[1..segments]=边缘点
