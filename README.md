...
- **图形渲染 / Graphics Rendering** - 基于 SDL3 的硬件加速渲染，采用顶点批处理技术 / Hardware-accelerated rendering based
  on SDL3 with vertex batching
- **窗口管理 / Window Management** - 多窗口支持，前台/后台/关闭状态切换 / Multi-window support with
  foreground/background/closed state switching
